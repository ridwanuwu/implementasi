            ...
            <div class="col-md-5">
                <div class="hasil" style="margin-top:15px;margin: left 10px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control barcode" id="barcode" placeholder="Hasil Barcode"
                            name="barcode">
                    </div>
                    <div class="form-group">
                        <label>Latitude Toko :</label>
                        <input type="text" class="form-control" id="latitude_toko" placeholder="Hasil Barcode"
                            name="barcode" value="">
                    </div>
                    <div class="form-group">
                        <label>longtitude Toko:</label>
                        <input type="text" class="form-control" id="longitude_toko" placeholder="Hasil Barcode"
                            name="barcode" value="">
                    </div>
                    <div class="form-group">
                        <label>Acuracy Toko :</label>
                        <input type="text" class="form-control" id="accuracy_toko" placeholder="Hasil Barcode"
                            name="barcode" value="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Acuracy User :</label>
                        <input type="text" class="form-control" id="accuracy" placeholder="Hasil Barcode"
                            name="barcode" value="">
                    </div>
...
function rata_accuracy() {
    ...
    result_acc = hassil / 2;
    console.log("akurasi user :")
    console.log(accuracy_user)
